            ...
            <div className="flex flex-col justify-center items-center">
              {loading ? (
                ...
                <>
                  ...
                  { imageSelected && <button onClick={handelUpdate} className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded">
                    Update
                  </button>
                  }
                </>
